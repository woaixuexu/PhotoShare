				...
				<form class="am-form tpl-form-line-form" action="" method="post">
					<div class="am-form-group">
						<input type="text" class="tpl-form-input" id="username"
							placeholder="请输入账号" onblur="checkUser()">
					</div>

					<div class="am-form-group">
						<input type="password" class="tpl-form-input" id="userpwd"
					...
					<div class="am-form-group">
						...
						<button type="button"
							class="am-btn am-btn-primary  am-btn-block tpl-btn-bg-color-success  tpl-login-btn" id="sumbit" name="sumber" disabled="disabled">提交</button>
					</div>
				</form>
			</div>
		</div>
